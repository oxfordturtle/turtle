...
### 1.1 Array-by-value parameter copy
...
### 1.3 Undo, Redo, Cut, Copy and Paste report "not implemented"
...
### 1.7 Underlined and strikethrough canvas text
...
### 1.8 `TRAC` and `MEMW` opcodes just pop the stack, and `traceOnRun` is dead
...
### 1.9 Seven of the eight `EncoderOptions` are dead
...
### 1.10 Python's indexed-array-assignment arm is dead code
